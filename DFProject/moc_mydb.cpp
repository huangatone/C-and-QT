...
QT_MOC_LITERAL(3, 18, 7), // "getName"
QT_MOC_LITERAL(4, 26, 9), // "getResult"
QT_MOC_LITERAL(5, 36, 4), // "seed"
QT_MOC_LITERAL(6, 41, 18) // "getCurrentDateTime"

    },
    "MyDB\0dataChanged\0\0getName\0getResult\0"
    "seed\0getCurrentDateTime"
};
...
void MyDB::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        MyDB *_t = static_cast<MyDB *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->dataChanged(); break;
        case 1: { QString _r = _t->getName();
            if (_a[0]) *reinterpret_cast< QString*>(_a[0]) = std::move(_r); }  break;
        case 2: { int _r = _t->getResult((*reinterpret_cast< int(*)>(_a[1])));
            if (_a[0]) *reinterpret_cast< int*>(_a[0]) = std::move(_r); }  break;
        case 3: { QDateTime _r = _t->getCurrentDateTime();
        ...
        {
            typedef void (MyDB::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MyDB::dataChanged)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject MyDB::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_MyDB.data,
      qt_meta_data_MyDB,  qt_static_metacall, nullptr, nullptr}
};
...
void *MyDB::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_MyDB.stringdata0))
        return static_cast<void*>(const_cast< MyDB*>(this));
